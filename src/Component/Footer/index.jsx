    ...
    <>
      <div className={style.footer}>
        <div className={style.footer_main}>
          ...
          <div className={style.consumer_policy}>
            <ul>CONSUMER POLICY</ul>
            <li>
              <a href="#">Cancellation & Returns</a>
            </li>
            <li>
          ...
          <div className={style.registered_address}>
        ...
        <div className={style.footer_bottom}>
          <div className={style.footer_bottom_main}>
            ...
            <div className={style.Gift_Cards}>
            ...
            <div className={style.copywrite}>© 2007-2024 Flipkart.com</div>
